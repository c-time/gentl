...
const getJsonAttribute = (o: GenerateOptions) => `${o.attributePrefix}-json`;
...
export const getGenerateConst = (o: GenerateOptions) => {
  ...
  return {
    ...
    queries: {
      scope: o.scope ? `${o.templateTagName}[${getScopeAttribute(o)}~="${o.scope}"]` : `${o.templateTagName}[${getScopeAttribute(o)}]`,
      text: `[${getTextAttribute(o)}]`,
      html: `[${getHtmlAttribute(o)}]`,
      json: `[${getJsonAttribute(o)}]`,
      attrs: `[${getAttrsAttribute(o)}]`,
      cloned: o.scope ? `[${getClonedAttribute(o)}~="${o.scope}"]` : `[${getClonedAttribute(o)}]`,
      if: `[${getIfAttribute(o)}]`,
      comment: `[${getCommentAttribute(o)}]`,
    },
  };
